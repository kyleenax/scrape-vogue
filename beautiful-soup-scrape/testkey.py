...
client = OpenAI(api_key="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")
import requests
import pandas as pd
